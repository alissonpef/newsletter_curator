...
def test_execute_kindle_not_configured():
    ...
    with pytest.raises(RuntimeError, match="Configure SMTP e o remetente autorizado antes de usar o envio para Kindle."):
...
def test_execute_success():
    ...
    state_repo_mock = Mock()
    digest_data = {
        "pdfArtifacts": [{"url": "http://example.com/test.pdf"}]
    }
